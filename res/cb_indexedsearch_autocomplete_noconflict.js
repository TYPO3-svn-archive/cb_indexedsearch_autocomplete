...
function selectItem(li) {	
	var thefield = jQuery("input[@name='tx_indexedsearch[sword]']");
...
jQuery(document).ready(function() {
	jQuery("input[@name='tx_indexedsearch[sword]']").autocomplete("http://" + top.location.host + top.location.pathname + "?eID=cb_indexedsearch_autocomplete&sr=" + sr + "&sh=" + sh + "", { minChars:3, matchSubset:1, matchContains:1, cacheLength:10, formatItem:formatItem, onItemSelect:selectItem, selectOnly:1 });
});
